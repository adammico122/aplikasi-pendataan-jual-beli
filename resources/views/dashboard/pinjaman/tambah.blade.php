@extends('layout.main')
@section('title', 'Hartono - Tambah Peminjam')
@section('content')
<main role="main" class="main-content">
    <div class="container-fluid">
      <div class="row justify-content-center">
        <div class="col-12">
          <h2 class="page-title">Input Data Peminjam</h2>
          <p class="text-muted">Masukkan Data Peminjam Dengan Sedetail Mungkin</p>
          ...
          @endif
          <form action="/pinjaman/tambah/data" method="POST">
          <div class="card shadow mb-4">
            <div class="card-header">
              <strong class="card-title">Data Peminjam & Produk</strong>
            </div>
            @csrf
            <div class="card-body">
                ...
                <div class="row m-lr-0 mb-2">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="nama_peminjam" id="nama_peminjam" placeholder="Masukkan Nama Peminjam Barang">
                    </div>
                </div>
            </div>
              </div>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row m-lr-0 mb-2">
                    ...
                    <div class="col-md-8">
                        <input type="number" class="form-control" name="jumlah_barang" placeholder="Masukkan Jumlah Barang">
                    </div>
                </div>
